...
public class BurgerQueen extends JFrame implements ActionListener {
	...
	private void addActionListeners() {
		...
		MasBebidas.btnAquariusZero.addActionListener(this);
		MasBebidas.btnCervezaSinAlcohol.addActionListener(this);
		MasBebidas.btnColaLight.addActionListener(this);
		MasBebidas.btnColaZero.addActionListener(this);
		MasBebidas.btnColaZeroZero.addActionListener(this);
		MasBebidas.btnLimonZero.addActionListener(this);
		MasBebidas.btnMonster.addActionListener(this);
		MasBebidas.btnNaranjaZero.addActionListener(this);
		MasBebidas.btnNestea.addActionListener(this);
		MasBebidas.btnNesteaSinAzucar.addActionListener(this);
		MasBebidas.btnTrina.addActionListener(this);
	}
	...
	private void addButtons() {
		...
		bgpBebida.add(MasBebidas.btnAquariusZero);
		bgpBebida.add(MasBebidas.btnCervezaSinAlcohol);
		bgpBebida.add(MasBebidas.btnColaLight);
		bgpBebida.add(MasBebidas.btnColaZero);
		bgpBebida.add(MasBebidas.btnColaZeroZero);
		bgpBebida.add(MasBebidas.btnLimonZero);
		bgpBebida.add(MasBebidas.btnMonster);
		bgpBebida.add(MasBebidas.btnNaranjaZero);
		bgpBebida.add(MasBebidas.btnNestea);
		bgpBebida.add(MasBebidas.btnNesteaSinAzucar);
		bgpBebida.add(MasBebidas.btnTrina);
	}
